...
def account_web_scraper(account_url, ticker, driver):
    try:
        ...
        username = driver.find_element(By.XPATH, ("//div[@data-testid='UserName']")).text.split("\n")[1]
        stock_symbols = driver.find_elements(By.XPATH, ("//span[@class='r-18u37iz']"))
        No_of_mentions = 0
...
def display_web_scraper(accounts_urls, ticker, time_interval):
    ...
    while 1:
        for url in accounts_urls:
            ...
            print(f"'{ticker}' was mentioned '{mentioned}'times in the last '{time_interval}'minutes in account'{username}'. ")
...
if __name__ == '__main__':
    ...
    ticker=input("Enter the stock symbol to Scrap(e.g. $TSLA, $AAPL, $SPY,etc..): ")
